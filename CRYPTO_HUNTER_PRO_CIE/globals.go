...
type ScanConfig struct {
	...
	SeedSource   string
	SkipChecksum bool
	SeedFormat   string // "bip39" ou "electrum"
...
func getDefaultNetworkGroups() []NetworkGroup {
	return []NetworkGroup{
		...
		{
			ID:     "liquid",
			NamePT: "Liquid Network (L-BTC)",
			NameEN: "Liquid Network (L-BTC)",
			Enabled: false,
			Derivations: []DerivationPath{
				{ID: "liquid_standard", NamePT: "Padrao Liquid (ex1...)", NameEN: "Standard Liquid (ex1...)",
					Path: "m/44'/1776'/0'/0/x", Purpose: 44, CoinType: 1776,
					AddressType: "liquid", Enabled: true},
			},
		},
	}
}
