...
set LDFLAGS=-s -w
set EXE_NAME_64=crypto_hunter_pro_x64.exe
set EXE_NAME_86=crypto_hunter_pro_x86.exe
...
set EXE_NAME_64=crypto_hunter_pro_x64_Expires_in_%EXP_DATE%.exe
set EXE_NAME_86=crypto_hunter_pro_x86_Expires_in_%EXP_DATE%.exe
